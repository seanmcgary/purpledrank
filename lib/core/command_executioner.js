...
var command_executioner = function(machine_server, config){
	...
	return _.extend(self, {
		...
		get_balance: function(socket, callback){
			var self = this;

			self.ldap.get_user_data(socket.auth_username, function(err, user_data){
				if(err === null){
		...
		machine_connected: function(alias, callback){
			...
			self.machine_server.machine_connected(alias, function(err, machine){
